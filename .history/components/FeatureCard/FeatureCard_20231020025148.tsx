...
type Props = {
  feature: Feature;
  feature2: Feature;
  editHandler2: Dispatch<SetStateAction<Feature>>;
};
        ...
        <div className="flex justify-start">
          ...
          className={
            priority === Priority.LOW
              ? "bg-[#dda06856] text-[#D58D49] rounded-[4px] px-[6px] py-1 font-medium text-xs"
              : priority === Priority.MEDIUM
              ? "bg-[#8dd24d65] text-[#ffffff] rounded-[4px] px-[6px] py-1 font-medium text-xs"
